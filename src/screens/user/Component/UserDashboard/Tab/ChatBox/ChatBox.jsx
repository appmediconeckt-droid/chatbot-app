...
//     // Show confirmation dialog - Using ConfirmModal instead of native Alert
//     setConfirmState({
//       visible: true,
//       title: 'Clear Chat',
...
//       </TouchableOpacity>
//     );
//   }, [renderCallItem, deleteMessage, openAttachment]);
  ...
  const renderMessage = useCallback(({ item }) => {
    ...
    return (
      <TouchableOpacity
        activeOpacity={1}
        onLongPress={() => {
          if (item.sender === "user" && !item.isTemporary) {
            setConfirmState({
              visible: true,
              title: 'Delete message',
              message: 'Delete this message?',
...
// [STYLES REMAIN THE SAME - FULL STYLES OBJECT FROM ORIGINAL CODE]
const styles = StyleSheet.create({
