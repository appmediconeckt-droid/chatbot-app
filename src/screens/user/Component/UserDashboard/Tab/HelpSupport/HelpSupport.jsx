...
const HelpSupport = ({ onClose, onOpenTab }) => {
  ...
  // Create dynamic support options using translations
  const supportOptions = [
    {
      icon: 'forum',
  ...
  const issueGuides = [
    {
      title: t('helpPage:aiChatNotReply'),
      text: t('helpPage:aiChatNotReplyDesc'),
    },
    {
      title: t('helpPage:counselorChatNotOpen'),
      text: t('helpPage:counselorChatNotOpenDesc'),
    },
    {
      title: t('helpPage:callNotConnecting'),
      text: t('helpPage:callNotConnectingDesc'),
    },
    {
      title: t('helpPage:walletPaymentIssue'),
      text: t('helpPage:walletPaymentIssueDesc'),
    },
    {
      title: t('helpPage:languageWrongTitle'),
      text: t('helpPage:languageWrongDesc'),
    },
  ];
