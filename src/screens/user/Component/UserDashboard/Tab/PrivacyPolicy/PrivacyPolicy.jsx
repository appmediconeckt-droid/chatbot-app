...
const PrivacyPolicy = ({ onClose, onOpenTab }) => {
  ...
  // Create dynamic privacy highlights using translations
  const privacyHighlights = [
    {
      icon: 'verified-user',
      label: t('privacyPage:otpProtected'),
      value: t('privacyPage:otpProtectedDesc'),
    },
    {
      icon: 'person-outline',
      label: t('privacyPage:anonymousCare'),
      value: t('privacyPage:anonCareDesc'),
    },
    {
      icon: 'lock-outline',
      label: t('privacyPage:sensitiveAreas'),
      value: t('privacyPage:sensitiveAreasDesc'),
    },
  ];
  ...
  const privacyDataGroups = [
    {
      icon: 'person',
      title: t('privacyPage:profileHealth'),
      text: t('privacyPage:profileHealthDesc'),
    },
    {
      icon: 'forum',
      title: t('privacyPage:aiConversations'),
      text: t('privacyPage:aiConversationsDesc'),
    },
    {
      icon: 'event-available',
      title: t('privacyPage:appointments'),
      text: t('privacyPage:appointmentsDesc'),
    },
    {
      icon: 'account-balance-wallet',
      title: t('privacyPage:wallet'),
      text: t('privacyPage:walletDesc'),
    },
    {
      icon: 'settings',
      title: t('privacyPage:location'),
      text: t('privacyPage:locationDesc'),
    },
    {
      icon: 'admin-panel-settings',
      title: t('privacyPage:security'),
      text: t('privacyPage:securityDesc'),
    },
  ];
  ...
  const privacyVisibility = [
    {
      ...
      text: t('privacyPage:visibleDesc'),
    },
    {
      title: t('privacyPage:sharedForCare'),
      text: t('privacyPage:sharedDesc'),
    },
    {
      title: t('privacyPage:protectedAccess'),
      text: t('privacyPage:protectedDesc'),
    },
  ];
