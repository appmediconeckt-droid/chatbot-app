    ...
    <SafeAreaView style={s.container} edges={['top']}>
      ...
      <ScrollView style={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.section}>
          ...
          <TouchableOpacity style={s.actionButton} onPress={handleChangePIN} activeOpacity={0.8}>
...
const s = StyleSheet.create({
  ...
  actionButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: PATIENT.primary, borderRadius: 10, paddingVertical: 12, marginTop: 12 },
